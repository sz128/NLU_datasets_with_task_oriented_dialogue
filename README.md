...
| [SNIPS](#snips) | Playlist, Restaurant, Weather, Music, RateBook, etc. | slot | slot tagging | https://github.com/snipsco/nlu-benchmark/tree/master/2017-06-custom-intent-engines |
